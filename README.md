...
Use this command to create VM, replacing example number "30" in box name and url with the copied link from above:
```
vagrant init devvm30 https://github.com/spryker/devvm/releases/download/ci-30/spryker-devvm.box
vagrant up
```
